      ...
      >
        ...
        <div
          className={cn(
            ...
            "group-data-[side=right]/sidebar-wrapper:pl-0"
          )}
        >
          <div
            data-sidebar="sidebar"
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      {showIcon && (
        <div
          className="size-4 rounded-sm bg-sidebar-accent-foreground/20"
          data-sidebar="menu-skeleton-icon"
        />
      )}
      <div
        className="h-4 bg-sidebar-accent-foreground/20 rounded-sm"
